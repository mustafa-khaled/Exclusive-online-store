...
function HeaderLinks() {
  ...
  return (
    <ul
      className={` header-links fixed	z-30 ${
        isSideBarActive ? "right-0" : "right-[-100%]"
      } top-[60px] order-3 flex h-[100vh] w-[100%] flex-col items-center justify-center gap-5 bg-gray md:static md:order-2 md:h-0 md:w-auto md:flex-row`}
    >
